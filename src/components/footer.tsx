        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 pt-2">
              <Link href="#" className="p-2 bg-slate-50 rounded-lg text-slate-400 hover:text-[#00bc8c] hover:bg-[#00bc8c]/5 transition-all">
          ...
          {/* Contact Column */}
          <div>
            <h4 className="text-slate-900 font-black text-[11px] uppercase tracking-[0.15em] mb-8">Contact Us</h4>
            <ul className="space-y-5">
              <li className="flex items-start gap-4">
                <div className="bg-slate-50 p-2.5 rounded-xl text-[#00bc8c]">
                  <Mail className="w-4 h-4" />
                </div>
                <div className="text-sm">
                   <p className="text-slate-400 font-bold text-[9px] uppercase tracking-wider mb-0.5">Email Support</p>
                   <p className="text-slate-700 font-extrabold">support@medistore.com</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-slate-50 p-2.5 rounded-xl text-[#00bc8c]">
                ...
                <div className="text-sm">
                   <p className="text-slate-400 font-bold text-[9px] uppercase tracking-wider mb-0.5">Phone Call</p>
                   <p className="text-slate-700 font-extrabold">+1 (800) MEDI-CARE</p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <div className="bg-slate-50 p-2.5 rounded-xl text-[#00bc8c]">
                ...
                <div className="text-sm">
                   <p className="text-slate-400 font-bold text-[9px] uppercase tracking-wider mb-0.5">Our Location</p>
                   <p className="text-slate-700 font-extrabold">123 Healthcare Way, NY 10001</p>
                </div>
              </li>
            </ul>
          </div>
