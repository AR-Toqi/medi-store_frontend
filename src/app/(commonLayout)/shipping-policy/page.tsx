      ...
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="bg-white dark:bg-slate-800 rounded-[3rem] p-8 md:p-16 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-slate-100 dark:border-slate-700">
          ...
          <div className="flex items-center gap-4 mb-12">
            <div className="bg-[#00bc8c]/10 dark:bg-[#00bc8c]/20 p-3 rounded-2xl">
              <Truck className="w-8 h-8 text-[#00bc8c]" />
            </div>
            <div>
              <h1 className="text-4xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Shipping Policy</h1>
              <p className="text-slate-500 dark:text-slate-400 font-medium uppercase text-[10px] tracking-widest mt-1">Delivery Information & Guidelines</p>
            </div>
          </div>
          ...
          <div className="prose prose-slate max-w-none space-y-12">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-3xl border border-slate-100 dark:border-slate-700">
                  <h4 className="font-bold text-slate-800 dark:text-slate-200 mb-2 italic">Standard Delivery</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400">2-4 business days for major metropolitan areas.</p>
                </div>
                <div className="bg-[#00bc8c]/5 dark:bg-[#00bc8c]/10 p-6 rounded-3xl border border-[#00bc8c]/10 dark:border-[#00bc8c]/20">
                  <h4 className="font-bold text-[#00bc8c] mb-2 italic">Express Delivery</h4>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Same-day or next-day delivery available in selected cities.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-slate-600 dark:text-slate-400 mt-4 ml-2">
