    ...
    <div className="container mx-auto px-4 py-10 max-w-4xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm col-span-1 md:col-span-1">
           ...
           <p className="text-slate-600 font-medium">{new Intl.DateTimeFormat('en-US', { month: 'long', day: '2-digit', year: 'numeric' }).format(new Date(order.createdAt))}</p>
           <p className="text-slate-400 text-sm mt-1">{new Intl.DateTimeFormat('en-US', { hour: 'numeric', minute: '2-digit', hour12: true }).format(new Date(order.createdAt))}</p>
        </div>
